...
class DBManager:
    ...
    def get_companies_and_vacancies_count(self):
        ...
        result = self.execute_query(
            ...
            'LEFT JOIN vacancies ON employers.employer_id = vacancies.employer_id GROUP BY employers.name')
        return result
    ...
    def get_all_vacancies(self):
        ...
        result = self.execute_query(
            ...
            'vacancies.url FROM employers JOIN vacancies using (employer_id)')
        return result
